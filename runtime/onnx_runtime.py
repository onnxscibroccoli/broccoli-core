...
_RULES: List[Tuple[str, Tuple[str, ...]]] = [
    ("bluetooth.off", ("bluetooth off", "disable bluetooth", "turn off bluetooth", "turn off bt")),
    ("bluetooth.on", ("bluetooth on", "enable bluetooth", "turn on bluetooth", "turn on bt", "turn on my bluetooth")),
    ("toggle_bluetooth", ("toggle bluetooth", "bluetooth", "bt ")),
